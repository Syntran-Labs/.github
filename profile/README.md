...
![LLMOps](https://img.shields.io/badge/Practice-Evals%20%26%20LLMOps-brightgreen?style=flat-square)
...
![Location](https://img.shields.io/badge/Based%20in-Montevideo%2C%20UY-lightgrey?style=flat-square)

**Building AI systems that turn intent into working, reviewable software.**

*Syntran = Synthetic Translation: AI-assisted engineering that converts ideas, specs,*
*and research into structured, auditable systems.*

[LinkedIn](https://www.linkedin.com/in/leonardo-sigales-58296619) · [Email](mailto:leonardo.sigales@gmail.com) · [Repositories](https://github.com/orgs/Syntran-Labs/repositories)
...
- ⚙️ Built **GenAI workflows** to improve user interaction at scale
- ☁️ Owned end-to-end systems on **Google Cloud** (BigQuery, Vertex AI), including a **production ML model** (fraud detection)
...
| Track | Purpose |
|---|---|
| 🏗️ **[systems-lab](https://github.com/Syntran-Labs/systems-lab)** | Production-oriented AI systems: secure RAG, agents, guardrails, observability, operational readiness |
...
```
Secure RAG & permission-aware retrieval    LLM agents: tool use, orchestration, guardrails
Evals & LLMOps: testing, tracing           AI-assisted & spec-driven software delivery
Engineering leadership for AI teams        Research-to-code exploration
```
...
![Anthropic](https://img.shields.io/badge/LLM%20APIs-Anthropic%20%7C%20OpenAI%20%7C%20Gemini-purple?style=flat-square)
